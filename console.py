...
ciri = Member("Ciri", "of Cintra", "premium")
yennefer = Member("Yennefer", "of Vengerberg", "premium")
geralt = Member("Geralt", "of Rivia", "premium")
tris = Member("Tris", "Merigold", "classic")
renfri = Member("Renfri", "of Creyden", "classic")
striga = Member("Striga", "the Monster", "classic")
